...
public enum MinionSpecialPowerType {
    ...
    IGNORE_ENEMY_HOLY_BUFF, UN_DISARM, UN_POISON, UNTI_BAD_EFFECT, DONOT_RECIVE_ATTACK_BY_WEAKER_FORCE, REMOVE_POSITIVE_EFFECTS,
    //these types would handle by type in
}
