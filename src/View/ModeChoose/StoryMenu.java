...
public class StoryMenu extends BorderPane {
    private Scene scene;
    ...
    StoryMenu() {
        ...
        ModeItem item = new ModeItem("LEVEL I", "you should kill enemy's hero to win");
        ModeItem item1 = new ModeItem("LEVEL II", "you have to collect at least half flags in map to win");
        ModeItem item2 = new ModeItem("LEVEL III", "you have to hold a flag for 6 turns to win");
